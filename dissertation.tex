...
To make the water level easy to adjust, the tube was in another tube full of water, so the inner tube could simply be pulled up and down to adjust the water level. Equation \ref{wavelengthEqn} was used to calculate the wavelength, and from that equation \ref{speedEqn} was used to calculate the speed of sound.

A diagram is shown in \ref{fig:setUp} for clarity.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{wavesBDiagram.png}
